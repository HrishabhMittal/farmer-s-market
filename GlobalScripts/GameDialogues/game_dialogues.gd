...
const CALL_POLICE_NO_TARGET = "911 Dispatch. You want to report... no one? You can't call the police without a specific merchant to investigate, silly! Call back when you're actually at a shop."
